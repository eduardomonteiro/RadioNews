function update() {
    $.ajax({
        url: 'http://localhost/Admin/BannersPAD/Update672x280',
        type: 'GET',
        success: function (data) {
            ...
            if ($('.center.featured-img')[0].style.backgroundImage.indexOf('Content/images/bg') < 0) {
                var url_bg_img = $('.center.featured-img')[0].style.backgroundImage;
    ...
    if (bg_img != '' && bg_img != null) {
        $('.center.featured-img')[0].style.backgroundImage = bg_img;
    }
