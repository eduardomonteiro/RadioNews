...
namespace Site.Controllers
{
    public class RedesSociaisController : BaseController
    {
        ...
        public string getPostsSocial()
        {
            ...
            List<RedeSocialModel> listaPosts = new List<RedeSocialModel>();
    ...
    {
        public RedeSocialTipo TipoRedeSocial { get; set; }
        ...
        public DateTime DataPublicacaoOrder
        {
            get
            {
                return Convert.ToDateTime(this.dataPublicacao);
            }
        }
    }
