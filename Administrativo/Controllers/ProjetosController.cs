...
{
    [CustomAuthorize(Roles = "Administrador,Programas Especiais")]
    public class ProjetosController : BaseController
    {
        ...
        public IPagedList<Noticias> GetListItens(int? page, string searchParam = "", string sortField = "", string order = "")
        {
            ...
            var list = db.Noticias.Where(a => !a.excluido && !a.transito && a.projeto && a.idColunista == null);
            ...
            if (!string.IsNullOrEmpty(searchParam))
            {
                ...
                pagedList = pagedList.Where(n => n.id == id || n.titulo.ToLower().Contains(searchParam.ToLower()) || n.texto.ToLower().Contains(searchParam.ToLower()) || n.url == searchParam);
            ...
            if (ModelState.IsValid)
            {
                ...
                if (db.SaveChanges() > 0)
                {
                    ...
                    if (foto != null)
                    {
                        ...
                        Utils.SaveAndCropImage(foto, path620x415, 0, 0, 620, 200, true, noticias.foto);
                        Utils.SaveAndCropImage(foto, path620x200, 0, 0, 620, 415, true, noticias.foto);
        ...
        public ActionResult Edit(Noticias noticias, HttpPostedFileBase audioUpload, HttpPostedFileBase fotoUpload, int[] TagsIds)
        {
            if (ModelState.IsValid)
            {
                ...
                if (fotoUpload != null)
                {
                    ...
                    Utils.SaveAndCropImage(fotoUpload, path620x415, 0, 0, 620, 200, true, noticias.foto);
                    Utils.SaveAndCropImage(fotoUpload, path620x200, 0, 0, 620, 415, true, noticias.foto);
