    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Seu password foi alterado."
                : message == ManageMessageId.SetPasswordSuccess ? "Seu password foi salvo."
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", "Sua senha está incorreta ou a nova senha é inválida.");
                    }
                }
            }
            else
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ModelState.AddModelError("", String.Format("Não foi possível criar a conta. Uma conta com o nome de usuário \"{0}\" já existe.", User.Identity.Name));
                    }
                }
            }
        ...
        //            else
        //            {
        //                ModelState.AddModelError("UserName", "Nome de usuário já existe. Por favor entre com um nome de usuário diferente.");
        //            }
        //        }
        //    }
